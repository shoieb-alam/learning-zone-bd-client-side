            ...
            <div className="text-start py-5">
                <Container>
                    <Row xs={1} md={2} lg={3} className="g-3">
                        ...
                        <Col>
                            <div>
                                <h1 className="brand text-success"> LEARNING ZONE </h1>
                            </div>
                        ...
                        <Col>
                            ...
                            <div className="mt-4">
                                ...
                                <Link className="text-decoration-none text-white" to="/courses">Courses</Link> <br />
                        ...
                        <Col>
                            ...
                            <div className="mt-4">
                                ...
                                <p>
                                    <FontAwesomeIcon icon={faEnvelopeOpen} className="me-2" /> support.lzbd@gmail.com
                                </p>
                                <p>
                                    <FontAwesomeIcon icon={faBuilding} className="me-2" /> Gulshan, Dhaka-1230 Bangladesh
                                </p>
                            </div>
                        </Col>
